                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/stations/otoño.png" class="img-fluid">
                                        <button onclick="document.getElementById('1').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">K’intun Ya’abil</button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Tikin le’</button>
                                        <button onclick="document.getElementById('2').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Ke’elil</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/intro-estaciones" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/estaciones-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
