                	...
                	<div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/figuras/stations/estaciones.png" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="/intro-estaciones"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/primer.png" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="estaciones-p-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/segundo.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="estaciones-s-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/tercer.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="estaciones-t-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/cuarto.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="estaciones-c-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
