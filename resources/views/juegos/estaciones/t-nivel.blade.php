                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/estaciones">Volver</a></li>
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <p>Iniciamos identificando las estaciones del año, selecciona la opción que creas correcta según la imagen mostrada</p>
                                        <img src="assets/img/figuras/stations/verano.png" class="img-fluid">
                                        <button onclick="document.getElementById('3').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Tikin le’</button>
                                        <button onclick="document.getElementById('4').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Yáax k’iin</button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">K’intun Ya’abil</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/estaciones-s-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/estaciones-c-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
