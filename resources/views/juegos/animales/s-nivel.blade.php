            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title" >Animales</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/animales">Volver</a></li>
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <p>Según lo aprendido anteriormente selecciona la opción correcta para el significado de los animales</p>
                                        <img src="assets/img/figuras/animals/gallina.png" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Kaax</button>
                                        <button onclick="document.getElementById('2').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Ma’ax</button>
                                        <button onclick="document.getElementById('3').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Báalam</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/animales-p-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/animales-t-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
