                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/animals/tucan.png" class="img-fluid">
                                        ...
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Pam</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/animales-t-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/animales-q-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
