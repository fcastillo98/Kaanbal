                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <p>Como ya sabes hay un gran número de animales por todo el mundo, pero para los mayas ese mundo era algo desconocido aunque tenían animales que conocían y entre ellos sobresalían:</p>
                                        <p> 
                                        ...
                                        <p> 
                                            3.- Jaguar = Báalam <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('3').play()">Escuchar</button><br>
                                        </p>
                                        <p> 
                                            4.- Pez = Kay <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('4').play()">Escuchar</button><br>
                                        </p>
                                        <p>
                                            5.- Tucán = Pam <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('5').play()">Escuchar</button>
                                        </p> 
