                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/animals/leopardo.png" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Báalam</button>
                                        <button onclick="document.getElementById('5').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Pam</button>
                                        <button onclick="document.getElementById('1').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Kaax</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/intro-animales" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/animales-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
