        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/animals/gorilla.png" class="img-fluid">
                                        
                                        <button onclick="document.getElementById('4').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Kay</button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Ma’ax</button>
                        ...
                        <span class="pull-right"><a href="/animales" class="flip-link btn btn-success" >Casa</a></span>
