                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/numbers/num2.png" class="img-fluid">
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 10.5%" >Ka'a</button><br>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 20%" onclick="document.getElementById('4').play()">Kan</button><br>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 20%; margin-top: 1% " onclick="document.getElementById('11').play()">Buluk</button><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="intro-num" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/num-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
