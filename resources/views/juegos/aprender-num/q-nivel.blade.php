                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/numbers/num17.png" class="img-fluid">
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 10.3%">U'uk lajun</button><br>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 20%" onclick="document.getElementById('13').play()">Óox lajun</button><br>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 20%; margin-top: 1% " onclick="document.getElementById('20').play()">Jun K'aal</button><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <span class="pull-left"><a href="/num-c-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/aprender-num" class="flip-link btn btn-success" >Casa</a></span>
