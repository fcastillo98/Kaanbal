                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Aprender Números</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                	...
                	<div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/figuras/numbers/all-numbers.png" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="/intro-num"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/primer.png" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="num-p-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/segundo.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="num-s-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/tercer.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="num-t-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/cuarto.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="num-c-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/quinto.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="num-q-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
