                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/numbers/num5.png" class="img-fluid">
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 10.4%" onclick="document.getElementById('8').play()">Waxak</button><br>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 20%">Jo'</button><br>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin-left: 20%; margin-top: 1% " onclick="document.getElementById('0').play()">Uh</button><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <span class="pull-left"><a href="/num-s-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/num-c-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
