            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Aprende los miembros de la familia en maya</h4>
                	...
                	<div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/figuras/family/familia.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="/intro-familia"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/primer.png" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="familia-p-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/segundo.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="familia-s-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/tercer.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="familia-t-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/cuarto.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="familia-c-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="assets/img/quinto.jpg" alt="user" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            ...
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="familia-q-nivel"><i class="mdi mdi-play"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
