                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/body-parts/labios.png" class="img-fluid">
                                        
                                        <button onclick="document.getElementById('4').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Ich</button>
                                        <button onclick="document.getElementById('3').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Ni’</button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Booxel chi’</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/partes-c-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/partes-cuerpo" class="flip-link btn btn-success" >Casa</a></span>
        </div>
    </div>
