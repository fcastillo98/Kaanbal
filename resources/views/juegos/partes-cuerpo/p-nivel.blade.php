            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title" >Partes del Cuerpo</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/partes-cuerpo">Volver</a></li>
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <p>Según lo aprendido anteriormente selecciona la opción correcta para el significado de las partes del cuerpo</p>
                                        <img src="assets/img/figuras/body-parts/nariz.png" class="img-fluid">
                                        <button onclick="document.getElementById('2').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Booxel chi’</button>
                                        <button onclick="document.getElementById('5').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Xikin</button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Ni’</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/intro-partes-cuerpo" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/partes-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
