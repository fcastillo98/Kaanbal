        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/geometry/circulo.png" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Wóolis</button>
                        ...
                        <span class="pull-left"><a href="/geo-c-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/geometria" class="flip-link btn btn-success" >Casa</a></span>
