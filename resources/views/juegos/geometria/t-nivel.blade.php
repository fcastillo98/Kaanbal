                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/geometry/rombo.png" class="img-fluid">
                                        ...
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">oochel kan xáax yaach’</button>
                                        <button onclick="document.getElementById('4').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">oochel kan xáax chowak</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/geo-s-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/geo-c-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
