                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/geometry/cuadrado.png" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">oochel kan xáax</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('1').play()">wóolis</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('4').play()">oochel kan xáax chowak</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/intro-geometria" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/geo-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
