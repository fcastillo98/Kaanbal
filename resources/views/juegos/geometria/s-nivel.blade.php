                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/geometry/triangulo.png" class="img-fluid">
                                        ...
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">óox tu’uk’</button>
                                        <button onclick="document.getElementById('5').play()" type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">oochel kan xáax yaach’</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/geo-p-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/geo-t-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
        </div>
    </div>
