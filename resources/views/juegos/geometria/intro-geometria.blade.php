            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Aprende a identificar las figuras geométricas en maya</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="geometria">Casa</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Geometría</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <p>Los mayas innovaron en cuanto a tecnología y arquitectura, aquí te enseñare algunas de las figuras geométricas básicas y sus traducciones al lenguaje maya.</p>
                                        <p> 
                                            1.- Círculo = Wóolis <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('1').play()">Escuchar</button><br>
                                        </p>
                                        <p>
                                            2.- Triángulo = óox tu’uk’ <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('2').play()">Escuchar</button><br>
                                        </p>
                                        <p>
                                            3.- Cuadrado = oochel kan xáax <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('3').play()">Escuchar</button><br>
                                        </p>
                                        <p>
                                            4.- Rectángulo = oochel kan xáax chowak <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('4').play()">Escuchar</button><br>
                                        </p>
                                        <p>
                                            5.- Rombo = oochel kan xáax yaach’ <button type="button" class="btn btn-info btn-sm" onclick="document.getElementById('5').play()">Escuchar</button>
                                        </p> 
                                        <img src="assets/img/figuras/geometry/geometria.png" class="img-fluid"><br>
                                        <span class="pull-right"><a href="/geo-p-nivel" class="flip-link btn btn-success" >Empecemos</a></span>
                                    </div>
