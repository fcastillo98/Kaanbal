                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/operaciones">Volver</a></li>
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <p>Según lo aprendido anteriormente selecciona el resultado correcto de la operación, selecciona la opción que creas correcta según el número mostrado</p>
                                        <img src="assets/img/figuras/numbers/resta1.png" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num2.png"></button>
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num7.png"></button>
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num4.png"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="intro-operaciones" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/op-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
