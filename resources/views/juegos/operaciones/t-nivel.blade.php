                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/numbers/suma3.png" class="img-fluid">
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num14.png"></button>
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num15.png"></button>
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num6.png"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/op-s-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/op-c-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
