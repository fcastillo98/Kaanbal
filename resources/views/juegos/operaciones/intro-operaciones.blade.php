            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Aprende a realizar operaciones con los números Maya</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="operaciones">Casa</a></li>
                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <p>Para sumar dos números mayas lo que hacemos es empezar con sumar los puntos y rayas el primer nivel del primer número maya con las rayas y puntos del primer nivel
                                        ...
                                        número maya y, así susesivamente para las restas es el mismo caso pero en lugar de sumar se restan los números.</p>
                                        <img src="assets/img/figuras/numbers/sumamaya.png" class="img-fluid">
                                        <img src="assets/img/figuras/numbers/restamaya.png" class="img-fluid"><br>
                                        <span class="pull-right"><a href="/op-p-nivel" class="flip-link btn btn-success" >Empecemos</a></span>
                                    </div>
