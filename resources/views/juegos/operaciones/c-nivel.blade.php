        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/numbers/resta2.png" class="img-fluid">
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num14.png"></button>
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num16.png"></button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num15.png"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <span class="pull-right"><a href="/op-q-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
