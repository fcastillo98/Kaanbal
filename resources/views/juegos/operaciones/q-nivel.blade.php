                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/numbers/suma4.png" class="img-fluid">
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num18.png"></button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num19.png"></button>
                                        <button type="button" class="btn btn-warning  pull-right" style="margin: 2%"><img src="assets/img/figuras/numbers/num17.png"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/op-t-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/operaciones" class="flip-link btn btn-success" >Casa</a></span>
