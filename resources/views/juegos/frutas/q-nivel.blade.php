                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/fruits/naranja.jpg" class="img-fluid">
                                        
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('jicama').play()">Chi’ikam</button>
                                        ...
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('naranja').play()">Pak’áal</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/frutas-c-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/frutas" class="flip-link btn btn-success" >Casa</a></span>
