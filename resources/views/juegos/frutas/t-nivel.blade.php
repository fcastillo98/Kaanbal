        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/fruits/aguacate.jpg" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('aguacate').play()">Oom</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('platano').play()">Ja’as</button>
                        ...
                        <span class="pull-left"><a href="/frutas-s-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/frutas-c-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
