                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <audio id="platano" src="assets/img/figuras/fruits/platano.m4a"></audio>
                                        <audio id="papaya" src="assets/img/figuras/fruits/papaya.m4a"></audio>
                                        <audio id="aguacate" src="assets/img/figuras/fruits/aguacate.m4a"></audio>
                                        ...
                                        <img src="assets/img/figuras/fruits/platano.png" class="img-fluid">
                                        
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('papaya').play()">Puut</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('aguacate').play()">Oom</button>
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('platano').play()">Ja’as</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/frutas-p-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/frutas-t-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
