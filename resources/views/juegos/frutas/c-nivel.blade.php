                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="assets/img/figuras/fruits/papaya.jpg" class="img-fluid">
                                        
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('papaya').play()">Puut</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Pak’áal</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%">Chi’ikam</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <span class="pull-left"><a href="/frutas-t-nivel" class="flip-link btn btn-danger" >Anterior</a></span>
                        <span class="pull-right"><a href="/frutas-q-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
               <FORM>       
        </div>
    </div>
