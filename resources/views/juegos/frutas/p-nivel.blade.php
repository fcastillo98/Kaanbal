            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title" >Frutas</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/frutas">Volver</a></li>
                 ...
                 <div class="card">
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <audio id="ciruela" src="assets/img/figuras/fruits/ciruela.m4a"></audio>
                                        <audio id="guayaba" src="assets/img/figuras/fruits/guayaba.m4a"></audio>
                                        <audio id="naranja" src="assets/img/figuras/fruits/naranja.m4a"></audio>
                                        <h1>Iniciamos nuestro aprendizaje de la cultura Maya</h1>
                                        <p>Según lo aprendido anteriormente selecciona la opción correcta para el significado de las frutas</p>
                                        <img src="assets/img/figuras/fruits/ciruela.jpg" class="img-fluid">
                                        <button onclick='alert("¡¡¡CORRECTO!!!")' type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('ciruela').play()">Abal</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('guayaba').play()">Pichi'</button>
                                        <button type="button" class="btn btn-warning btn-lg pull-right" style="margin: 2%" onclick="document.getElementById('naranja').play()">Pak’áal</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <span class="pull-left"><a href="/intro-frutas" class="flip-link btn btn-danger" >Introducción</a></span>
                        <span class="pull-right"><a href="/frutas-s-nivel" class="flip-link btn btn-success" >Siguiente</a></span>
